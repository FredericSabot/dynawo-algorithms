...
module load trinity/all gcc/7.2.0 mvapich2/gcc72/psm2
...
./dynawo-algorithms/dynawo-algorithms.sh SA --directory IEEE39/protected$SLURM_ARRAY_TASK_ID/N-2_Analysis --input fic_MULTIPLE.xml --output aggregatedResults.xml --nbThreads 12
