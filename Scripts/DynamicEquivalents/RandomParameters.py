...
def writeStaticParams(static_parameters_dic, output_dir, target_Q=None, slack_load_id=None, slack_gen_id=None):
    """
...
def writeParametricSAInputs(working_dir, fic_MULTIPLE, output_dir_name, static_data_dic, dyn_data_dic, run_id, target_Q=None, slack_load_id=None, slack_gen_id=None):
    """
    ...
    # Write new .iidm's
    writeStaticParams(static_data_dic, output_dir, target_Q, slack_load_id, slack_gen_id)        
